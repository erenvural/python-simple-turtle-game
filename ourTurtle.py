...
#############################################################################
    @staticmethod
    def _Mouse():
        img = TK.PhotoImage(file=".\\img\\mouse.gif", width=18, height=22)
        return img
    @staticmethod
    def _Eagle():
        img = TK.PhotoImage(file=".\\img\\eagle.gif", width=21, height=22)
        return img
    @staticmethod
    def _Key():
        img = TK.PhotoImage(file=".\\img\\key.gif", width=23, height=18)
        return img
    @staticmethod
    def _Door():
        img = TK.PhotoImage(file=".\\img\\door.gif", width=15, height=23)
        return img
#############################################################################
    @staticmethod
    def _blankimage():
        ...
        self._shapes = {
                ...
                "triangle" : Shape("polygon", ((10,-5.77), (0,11.55),
                  ...
                  "classic": Shape("polygon", ((0,0),(-5,-9),(0,-7),(5,-9))),
                   ...
                   "snake" : Shape("polygon", ((0,9), (2,6), (1,4), (1,-7), (0,-9),
                                               (-1,-7), (-1,4), (-2,6), (0,9))), # =>Shape1 Changes
                   "mouse" : Shape("image", self._Mouse()), # ======================>Shape2 Changes
                   "eagle" : Shape("image", self._Eagle()), # ======================>Shape3 Changes
                   "key"   : Shape("image", self._Key()),   # ======================>Shape4 Changes
                   "door"  : Shape("image", self._Door())   # ======================>Shape5 Changes
                  }
