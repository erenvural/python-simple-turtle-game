...
class MazeTurtle(ourTurtle.Turtle):
    def __init__(self):
        ourTurtle.Turtle.__init__(self)  # first initialize MazeTurtle as a Turtle
        self.penup()
        self.shape("turtle")
...
def clear_screen(t):
    t.fillcolor(bg_color)
    fill_rect(t,-253,207,22*23,18*23)
